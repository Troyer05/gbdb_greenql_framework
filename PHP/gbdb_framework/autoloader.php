...
/**
 * Kleine mbstring-Fallbacks für Minimal-Server ohne php-mbstring.
 * Die Framework-Funktionen bleiben UTF-8-freundlich, laufen aber auch
 * auf schlanken Debian/Pi-Installationen ohne Fatal Error weiter.
 */
